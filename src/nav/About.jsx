  ...
  return (
    <div className="h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url(${bgImg})` }}>
      <div className="container mx-auto p-6 bg-white rounded-md">
        <h2 className="text-3xl font-bold mb-4 text-center">About Storecode</h2>
        <p className="text-sm mb-4">
        Welcome to Storecode, where innovation meets inspiration! We're not just a website; we're a gateway to a world of limitless possibilities.</p>
        <p className="text-sm mb-4">
At Storecode, we believe that every product tells a unique story. From the trendsetting fashion items that define your style to the cutting-edge tech gadgets that elevate your daily life, each product has a tale to tell. Our mission is to make these stories accessible, shareable, and unforgettable.
        ...
        <div className="mb-4">
        <h3 className="text-xl font-semibold mb-2 text-center" style={{ color: '#8B5CF6' }}>Why Unique Codes?</h3>
        ...
        <div className="mb-4">
        <h3 className="text-xl font-semibold mb-2 text-center" style={{ color: '#8B5CF6' }}>For Influencers and Creators</h3>
        ...
        <div className="mb-4">
        <h3 className="text-xl font-semibold mb-2 text-center" style={{ color: '#8B5CF6' }}>For Curious Shoppers</h3>
        ...
        <div className="mb-4">
        <h3 className="text-xl font-semibold mb-2 text-center" style={{ color: '#8B5CF6' }}>Our Commitment to You</h3>
          ...
          <p className="text-sm mt-4">
          Welcome to Storecode, where the world's most exciting products are just a code away!
          </p>
          <p className="text-sm mt-4">
          Ready to dive into the world of Storecode? Start exploring now!
          </p>
